...
class blackboard_calendar:
    ...
    def download_calendar(self, url, as_table):
        ...
        event_info = self.parse_to_table(events)
    ...
    def test(self):
        event_info = self.download_calendar('https://learn.dcollege.net/webapps/calendar/calendarFeed/c2d84bf6673c402cb557f2a84ddabd87/learn.ics',True)
